        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-rose-400 bg-clip-text text-transparent">
                  Ice & Spice
                </span>
            ...
            <div className="text-zinc-400 text-center md:text-right">
              <p>&copy; 2026 Ice & Spice Restaurant. All rights reserved.</p>
